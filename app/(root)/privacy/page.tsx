      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <div className="p-4 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white w-fit mx-auto mb-6">
            ...
            <Card className="glass bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-white/20 dark:border-slate-700/50 rounded-3xl">
              <CardContent className="p-8 md:p-12">
                <div className="prose prose-lg dark:prose-invert max-w-none">
                  ...
                  {/* Contact Section */}
                  <div
                    className={`mt-16 p-8 glass bg-blue-500/10 border border-blue-200/30 dark:border-blue-700/30 rounded-2xl ${isRTL ? "text-right" : ""}`}
                  >
                    ...
                    <div className={`space-y-2 text-sm ${isRTL ? "font-arabic" : ""}`}>
                      <p>
                        <strong>{t("contact.email")}:</strong> privacy@badji.net
                      </p>
                      <p>
                    ...
                    <Button
                      className={`mt-6 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white border-0 rounded-full ${isRTL ? "font-arabic" : ""}`}
                      asChild
                    >
