...
import { ChevronDown as CaretDownIcon, CheckIcon } from "lucide-react";
    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <ToggleGroupItem
            tabIndex={0}
            className="relative size-7 w-7 h-7  rounded-md p-0"
            value={color.cssVar}
            aria-label={label}
...
export const SectionThree: React.FC<SectionThreeProps> = ({
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="start" className="w-[max-content]">
